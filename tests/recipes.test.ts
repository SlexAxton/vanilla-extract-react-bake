...
describe('recipes', () => {
  it('should return default variants for no options', () => {
    expect(basic()).toMatchInlineSnapshot(
      `"recipes_basic__10l496p0 recipes_basic_spaceWithDefault_small__10l496p1"`,
    );
  });
  ...
  it('should return requested variants', () => {
    expect(
      ...
      `"recipes_basic__10l496p0 recipes_basic_spaceWithDefault_large__10l496p2 recipes_basic_spaceWithoutDefault_small__10l496p3 recipes_basic_color_blue__10l496p6"`,
    );
  });
  ...
  it('should return requested compound variants', () => {
    expect(
      ...
      `"recipes_basic__10l496p0 recipes_basic_spaceWithDefault_small__10l496p1 recipes_basic_color_red__10l496p5 recipes_basic_compound_0__10l496p8"`,
    );
  });
  ...
  it('should return boolean variants', () => {
    expect(basic({ rounded: true })).toMatchInlineSnapshot(
      `"recipes_basic__10l496p0 recipes_basic_spaceWithDefault_small__10l496p1 recipes_basic_rounded_true__10l496p7"`,
    );
  });
  ...
  it('should have base class name even when "base" prop is not defined', () => {
    expect(empty()).toMatchInlineSnapshot(`"recipes__10l496p9"`);
    expect(empty.classNames.base).toMatchInlineSnapshot(`"recipes__10l496p9"`);
  ...
  it('should include generated base class name for provided string classes', () => {
    expect(definedStringBase()).toMatchInlineSnapshot(
      `"recipes__10l496pa definedStringBase"`,
    );
    ...
    expect(definedStringBase({ variant: 'simple' })).toMatchInlineSnapshot(
      `"recipes__10l496pa definedStringBase recipes_definedStringBase_variant_simple__10l496pb simple-one"`,
    );
    expect(
      definedStringBase.classNames.variants.variant.simple,
    ).toMatchInlineSnapshot(
      `"recipes_definedStringBase_variant_simple__10l496pb"`,
    );
  });
  ...
  it('should include generated base class name for provided array string classes', () => {
    expect(definedStringBaseArray()).toMatchInlineSnapshot(
      `"recipes_definedStringBaseArray__10l496pc definedStringBaseInArray_1 definedStringBaseInArray_2"`,
    );
    expect(definedStringBaseArray.classNames.base).toMatchInlineSnapshot(
      `"recipes_definedStringBaseArray__10l496pc"`,
    );

    expect(definedStringBaseArray({ variant: 'simple' })).toMatchInlineSnapshot(
      `"recipes_definedStringBaseArray__10l496pc definedStringBaseInArray_1 definedStringBaseInArray_2 recipes_definedStringBaseArray_variant_simple__10l496pd simple-one simple-two"`,
    );
    expect(
      definedStringBaseArray.classNames.variants.variant.simple,
    ).toMatchInlineSnapshot(
      `"recipes_definedStringBaseArray_variant_simple__10l496pd"`,
    );
  });
  ...
  it('should expose variants class names', () => {
    expect([
      ...
      [
        "recipes_basic__10l496p0",
        "recipes_basic_spaceWithDefault_large__10l496p2",
        "recipes_basic_spaceWithDefault_small__10l496p1",
        "recipes_basic_spaceWithoutDefault_large__10l496p4",
        "recipes_basic_spaceWithoutDefault_small__10l496p3",
        "recipes_basic_color_blue__10l496p6",
        "recipes_basic_color_red__10l496p5",
        "recipes_basic_rounded_true__10l496p7",
      ]
    `);
  });
});
